      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {mockProjects.map((project) => (
            <div key={project.id} className="group bg-white rounded-3xl border border-slate-200 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center space-x-4">
                  <a href={project.link} className="text-indigo-600 font-bold text-sm hover:underline decoration-2 underline-offset-4">
                    라이브 데모 →
                  </a>
                  {project.github && (
